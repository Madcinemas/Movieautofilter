...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Primax Movie™](https://t.me/primax_movie)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n↭ <b>Join Now [Primax Movies™](https://t.me/primax_movie)</b> ↭")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query:\n🏷 Title: <a href={url}>{title}</a>\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n⚠️Click on the button 👇 below to get your query privately")
